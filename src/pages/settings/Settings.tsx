    ...
    <div className="min-h-screen bg-[#04060C]" style={{ fontFamily: "'Inter',sans-serif" }}>
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="space-y-8">
          ...
          {isConnected && (
            <button onClick={() => disconnect()} className="w-full flex items-center justify-center gap-2 px-4 py-3.5 border border-rose-400/30 text-rose-400 text-sm font-bold hover:bg-rose-400/5 transition-all">
